...
public class TestObserver {
	...
	public void setUp() throws Exception {
		...
		List<CondicionPreexistenteI> inadecuados = new ArrayList<CondicionPreexistenteI>();
		 ...
		 receta = new Receta("Ensalada",1524.0,preparacion,dificultad,temporada,subRecetas,inadecuados);
	...
	@Test
	public void testObserverRecetaConsultadaEnLaHoraActual(){
	...
	@Test
	public void testObserverRecetaConsultadaALas55(){
		...
		assertEquals(obPH.consultadasEnLaHora(55),0.0,0.001);
